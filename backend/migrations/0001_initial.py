    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Пользователь с данным именем уже присутствует.'}, help_text='Не более 150 символов. Буквы, цифры или @/./+/-/_.', max_length=150, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('structure', models.CharField(blank=True, max_length=30, verbose_name='Корпус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Работает'), ('closed', 'Закрыт')], default='active', max_length=8, verbose_name='Статус магазина')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reset_tokens', to=settings.AUTH_USER_MODEL, verbose_name='The User which is associated to this password reset token')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='productinfo',
            constraint=models.UniqueConstraint(fields=('product', 'shop', 'info_id'), name='unique_product_info'),
        ),
        migrations.AddConstraint(
